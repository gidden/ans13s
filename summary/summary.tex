...
for the once-through fuel cycle. The once-through case was chosen because of
it's simplicity - it allows for direct, simple comparisons amonth various
simulation mechanics regarding building decisions and material flows. A natural
next step is to expand these tools for advanced fuel cycles, perhaps first those
with single MOX recycle and then more generally for fuel recycle via
